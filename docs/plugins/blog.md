...
!!! info "Format of author information"
    ...
    with posts, e.g., a GitHub username like `mstrohl`. This identifier can
  ...
  [.authors.yml]: https://github.com/mstrohl/mkdocs-material/blob/master/docs/blog/.authors.yml
