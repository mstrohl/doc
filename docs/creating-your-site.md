...
=== "Unix, Powershell"
    ...
    ```
    docker run --rm -it -v ${PWD}:/docs mstrohl/mkdocs-material new .
    ```

=== "Windows (cmd)"

    ```
    docker run --rm -it -v "%cd%":/docs mstrohl/mkdocs-material new .
    ```
...
???+ tip "Recommended: [configuration validation and auto-complete]"
    ...
    === "Visual Studio Code"
        ...
        2.  Add the schema under the `yaml.schemas` key in your user or
            ...
            {
              "yaml.schemas": {
                "https://mstrohl.github.io/mkdocs-material/schema.json": "mkdocs.yml"
              },
              "yaml.customTags": [ // (1)!
                "!ENV scalar",
                "!ENV sequence",
    ...
    === "Other"
        ...
        2.  Add the following lines at the top of `mkdocs.yml`:
            ...
            ``` yaml
            # yaml-language-server: $schema=https://mstrohl.github.io/mkdocs-material/schema.json
            ```
  ...
  [configuration validation and auto-complete]: https://twitter.com/mstrohl/status/1487746003692400642
  [schema.json]: schema.json
  [vscode-yaml]: https://marketplace.visualstudio.com/items?itemName=redhat.vscode-yaml
  [settings.json]: https://code.visualstudio.com/docs/getstarted/settings
  [extension]: https://github.com/mstrohl/mkdocs-material/tree/master/docs/schema/extensions
  [plugin]: https://github.com/mstrohl/mkdocs-material/tree/master/docs/schema/plugins
...
=== "Unix, Powershell"
    ...
    ```
    docker run --rm -it -p 8000:8000 -v ${PWD}:/docs mstrohl/mkdocs-material
    ```

=== "Windows"

    ```
    docker run --rm -it -p 8000:8000 -v "%cd%":/docs mstrohl/mkdocs-material
    ```
...
=== "Unix, Powershell"
    ...
    ```
    docker run --rm -it -v ${PWD}:/docs mstrohl/mkdocs-material build
    ```

=== "Windows"

    ```
    docker run --rm -it -v "%cd%":/docs mstrohl/mkdocs-material build
    ```
