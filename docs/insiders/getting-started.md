...
repository, you need to [become an eligible sponsor] of @mstrohl on GitHub.
...
=== "Specific release"
    ...
    ``` sh
    pip install git+https://${GH_TOKEN}@github.com/mstrohl/mkdocs-material-insiders.git@9.4.2-insiders-4.42.0
    ```

=== "Latest"

    ``` sh
    pip install git+https://${GH_TOKEN}@github.com/mstrohl/mkdocs-material-insiders.git
    ```

[list of tags]: https://github.com/mstrohl/mkdocs-material-insiders/tags
...
```
git clone git@github.com:mstrohl/mkdocs-material-insiders.git mkdocs-material
```
...
```
  ...
  [Fork the Insiders repository]: https://github.com/mstrohl/mkdocs-material-insiders/fork
  ...
  [publish]: https://github.com/mstrohl/mkdocs-material-insiders/blob/master/.github/workflows/publish.yml
