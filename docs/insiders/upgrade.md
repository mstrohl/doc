...
=== "pip upgrade to release"
    ...
    ```
    pip install --upgrade git+https://${GH_TOKEN}@github.com/mstrohl/mkdocs-material-insiders.git@9.4.2-insiders-4.42.0
    ```
...
=== "pip upgrade to latest development"
    ...
    ```
    pip install --upgrade git+https://${GH_TOKEN}@github.com/mstrohl/mkdocs-material-insiders.git
    ```
